...
local Library    = {}
local Images     = {"user","dice","gun","visualization-of-data","grab"}
...
function Library:PlayAudio(id: number)
    ...
    if Boombox then 
        ...
        task.spawn(function()
            repeat task.wait() until LocalPlayer.Character.LowerTorso:WaitForChild("BOOMBOXSOUND").SoundId == "rbxassetid://"..tostring(id)
